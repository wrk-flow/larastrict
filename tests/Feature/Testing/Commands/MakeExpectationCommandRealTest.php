...
use Tests\LaraStrict\Feature\Testing\Commands\MakeExpectationCommand\SimpleActionContractExpectationThrow;
...
class MakeExpectationCommandRealTest extends TestCase
{
    ...
    public function testGeneratedFiles(): void
    {
        ...
        $this->assertTrue(class_exists(SimpleActionContractExpectationThrow::class));
