...
#[\LaraStrict\Testing\Attributes\Expectation(class: MultiFunctionContractSelfExpectation::class)]
#[\LaraStrict\Testing\Attributes\Expectation(class: MultiFunctionContractPhpDocThisExpectation::class)]
#[\LaraStrict\Testing\Attributes\Expectation(class: MultiFunctionContractPhpDocThisParamsExpectation::class)]
#[\LaraStrict\Testing\Attributes\Expectation(class: MultiFunctionContractPhpDocBoolExpectation::class)]
#[\LaraStrict\Testing\Attributes\Expectation(class: MultiFunctionContractPhpDocStringExpectation::class)]
#[\LaraStrict\Testing\Attributes\Expectation(class: MultiFunctionContractPhpDocFloatExpectation::class)]
#[\LaraStrict\Testing\Attributes\Expectation(class: MultiFunctionContractPhpDocMixedExpectation::class)]
#[\LaraStrict\Testing\Attributes\Expectation(class: MultiFunctionContractPhpDocStaticExpectation::class)]
#[\LaraStrict\Testing\Attributes\Expectation(class: MultiFunctionContractSelfViaClassExpectation::class)]
#[\LaraStrict\Testing\Attributes\Expectation(class: MultiFunctionContractNoReturnExpectation::class)]
#[\LaraStrict\Testing\Attributes\Expectation(class: MultiFunctionContractMixedExpectation::class)]
#[\LaraStrict\Testing\Attributes\Expectation(class: MultiFunctionContractNoParamsExpectation::class)]
class MultiFunctionContractAssert extends \LaraStrict\Testing\Assert\AbstractExpectationCallsMap implements \Tests\LaraStrict\Feature\Testing\Commands\MakeExpectationCommand\MultiFunctionContract
{
    /**
